...
histogram income14, discrete frequency xlabel(1(0)5) title(Number of Time able to Eat Fruit)
...
graph hbar (mean) health14, over(PROV)
...
**self reported health bean wil return****************

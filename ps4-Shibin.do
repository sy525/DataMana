...
recode ethnic14  (1=0) (2 3 4 5 6 7 8=1) 
...
drop _merge
* Data from China Statistical Yearbook 2018.
/*merge7*/
use "https://docs.google.com/uc?id=1Sb_fGGdRiVSxFpcfHbp7RaV2QauGxi_q&export=download",clear
...
* Data from WHO Study on Global AGEing and Adult Health 2007-2010.
...
replace PROV1 = proper(PROV1)
drop PROV
merge m:m PROV1 using merge11 
* Data from Research on Early Life and Aging Trends and Effects: A Cross-National Study 1996-2008.

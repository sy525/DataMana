...
merge 1:m PROV1 using agemeg, nogen
sort PROV1
list PROV1 if _merge==1
list PROV1 if _merge==2
save healthfinal, replace
*list PROV1 if _merge==1 | _merge==2
...
Exclude the people under 65 years.
*/
twoway(scatter rev_health14 age14) if age14>65|| lfit rev_health14 age14, title(Age and Health Assocation Over 65)
/* Here, the graphy tells us that the relationship between health and age is negative. It matched with our
observation. 
*/
...
///graph matrix provides us a quick way to examine the relationship among our variables. 
...
rural counterparts.Quite opposite, in the regression table, elderly in rural area have 0.123 more unit increase on 
...
graph bar (frequency) happiness14, over(rural14)
...
* Interaction 1
reg rev_health14 Urban14 i.ethnic14 Urban14#ethnic14 income14 education14 employment14 smoking14 marital14 sex14 familysize14 age14,robust 
...
reg rev_health14 i.rural14##c.familysize14
margins rural14

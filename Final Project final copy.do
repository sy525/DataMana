...
decrease. In addition, as hold other control variable constant, the effect of famioy size may seem surprising-it is negative! 
In other words, the more people that elderly live with, the worse their health, which is opposite with the literature. 
*/
...
/* 
From the regression table, we can see that happiness/ Subjective well-being (SWB) have a significant effect on health of elderly. 
And then, we can find that elderly in rural report a better health than their counterparts in town and city! According to 
Dr.Adam's SWB theory, nature envrionment make people happier. So elderly in rural areas get more chance to exposure to nature 
enviornment than their counterparts in city. So they tends to become happier. 
*/

...
outreg2 using reg11.doc
/* 
We expect to see that elderly living in city have better health than their counterparts in rural area. Quite opposite, in the regression table, it shows
that we can find that elderly have 0.123 increase on health compared to elderly in city, holding other variables constant. The elderly in rural area have 
better health than the elderly in the city. It is so surprise outcome! But we don't find correlation between the health of elderly in town and the health
of elderly in rural. 
*/
...
/*  
//-----------------Violation------------------------------------------------
use "D:\Chrome Download\ICPSR_28143-V1\ICPSR_28143\DS0001\28143-0001-Data.dta",clear
reg HAPPY ldance
predict HAPPYhat
graph twoway (scatter HAPPY ldance) (line HAPPYhat ldance, sort)
graph twoway (scatter HAPPY ldance) (lfit HAPPY ldance)
reg HAPPY ldance AGE HEALTH HHINC0 MARITAL
rvfplot, yline(0)
...
estat imtest
estat szroeter, rhs
//looks like if we regress on exp only there is less heteroskedascity.
*/
